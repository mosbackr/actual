...
class AcutalStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        # VPC — public subnets only (no NAT gateways, avoids EIP limits)
        vpc = ec2.Vpc(self, "AcutalVpc",
            max_azs=2,
            nat_gateways=0,
        ...
        # RDS PostgreSQL (publicly accessible for migrations, secured by SG)
        ...
        db.connections.allow_default_port_from_any_ipv4("Allow migrations from anywhere")
